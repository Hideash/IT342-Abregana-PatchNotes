...
// //         content: textToSend,
// //       });
// //       fetchMessages(selectedPartner.email); // Refresh to get real server ID
// //     } catch (err) {
// //       console.log("Error sending message:", err);
...
// //       {/* New Message Modal */}
// //       {showNewMsg && (
// //         <div style={s.newMsgModal} onClick={(e) => {
// //           if (e.target === e.currentTarget) setShowNewMsg(false);
// //         }}>
...
// //                 {messages.length === 0 && (
// //                   <div style={{ textAlign: "center", color: "#555570", padding: "40px 0", fontSize: "13px" }}>
