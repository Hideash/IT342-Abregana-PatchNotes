...
// import edu.cit.abregana.patchnotes.service.PatchService;
...
public class PatchController {
    ...
    @GetMapping("/{patchId}/posts")
    public ResponseEntity<List<PostResponse>> getPatchPosts(
            @PathVariable Long patchId,
            Principal principal) {
        return ResponseEntity.ok(patchService.getPostsByPatch(patchId, principal.getName()));
    }
}